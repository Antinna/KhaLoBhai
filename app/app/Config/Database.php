...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        $this->tests['hostname'] = env('DB_TEST_HOST', '127.0.0.1');
        $this->tests['username'] = env('DB_TEST_USERNAME', '');
        $this->tests['password'] = env('DB_TEST_PASSWORD', '');
        $this->tests['database'] = env('DB_TEST_NAME', ':memory:');
        $this->tests['port']     = env('DB_TEST_PORT', 3306);
